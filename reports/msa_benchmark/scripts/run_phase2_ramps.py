#!/usr/bin/env python3
"""
Phase 2 Benchmark: Temperature Continuation Ramps (Annealing)
Evaluates dipolar hard spheres with multi-stage geometric continuation.
"""
...
OUTPUT_DIR = "reports/msa_benchmark/data/phase2"
...
results = []
print("=" * 80)
print("=== Phase 2: Temperature Continuation Ramps (Annealing Benchmark) ===")
print("=" * 80)
