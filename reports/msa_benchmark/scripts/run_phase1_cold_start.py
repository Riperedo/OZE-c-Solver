#!/usr/bin/env python3
"""
Phase 1 Benchmark: Standard Cold-Start Solver (No Initializer, No Ramps)
Evaluates dipolar hard spheres across phi in [0.1, 0.5] and T* in [10.0, 1.0, 0.1, 0.01].
"""
...
OUTPUT_DIR = "reports/msa_benchmark/data/phase1"
...
def compute_rmse(num_file, ana_file):
    ...
    try:
        ...
        # Interpolate num onto ana k grid
...
results = []
print("=" * 80)
print("=== Phase 1: Standard Cold-Start Benchmark (No Initializer, No Ramps) ===")
print("=" * 80)
