...
\begin{align}
    ...
    S^{110}(k) &= \frac{1}{3} \left[ S^0(k) + 2 S^1(k) \right] = 1 + \frac{\rho}{3} H^{110}(k), \\
    S^{112}(k) &= \frac{1}{3} \left[ S^0(k) - S^1(k) \right] = \frac{\rho}{3} H^{112}(k).
\end{align}
...
\begin{align}
    S^0(k) &= S^{110}(k) + 2 S^{112}(k), \\
    S^1(k) &= S^{110}(k) - S^{112}(k).
\end{align}
...
\begin{equation}
    S^{000}(k) \to 1.0, \quad S^{110}(k) \to 1.0, \quad S^{112}(k) \to 0.0.
\end{equation}
